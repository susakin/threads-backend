...
export declare class SavePostController {
    ...
    create(postId: string, request: any): Promise<import("mongoose").Document<unknown, {}, import("./schema/like.schema").SavePostDocument> & import("./schema/like.schema").SavePost & import("mongoose").Document<any, any, any> & {
